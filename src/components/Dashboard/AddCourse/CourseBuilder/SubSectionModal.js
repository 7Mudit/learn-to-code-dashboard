...
export default function SubSectionModal({
  ...
  useEffect(() => {
    if (view || edit) {
      ...
      setValue("lectureTitle", modalData.heading)
      setValue("lectureDesc", modalData.content)
    }
  }, [])
  ...
  const isFormUpdated = () => {
    ...
    if (
      currentValues.lectureTitle !== modalData.heading ||
      currentValues.lectureDesc !== modalData.content 
    ) {
      return true
    }
    return false
  ...
  const handleEditSubsection = async () => {
    ...
    if (currentValues.lectureTitle !== modalData.title) {
      formData.append("heading", currentValues.lectureTitle)
    }
    if (currentValues.lectureDesc !== modalData.description) {
      formData.append("content", currentValues.lectureDesc)
    }
    setLoading(true)
  ...
  const onSubmit = async (data) => {
    ...
    formData.append("heading", data.lectureTitle)
    formData.append("content", data.lectureDesc)
    setLoading(true)
